...
namespace Microting.EformAngularFrontendBase.Migrations
{
    ...
    [Migration("20260411082732_AddThemeVariantToUser")]
    partial class AddThemeVariantToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsMenu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsMenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsCmsEnabled")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsMenuSticky")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsMenuItem", b =>
                {
                    b.HasOne("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsMenu", "Menu")
                        .WithMany("Items")
                        .HasForeignKey("CmsMenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsPage", "Page")
                        .WithMany()
                        .HasForeignKey("PageId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsMenuItem", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsSettings", b =>
                {
                    b.HasOne("Microting.EformAngularFrontendBase.Infrastructure.Data.Entities.Cms.CmsMenu", "ActiveMenu")
                        .WithMany()
                        .HasForeignKey("ActiveMenuId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ActiveMenu");
                });
